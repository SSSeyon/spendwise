...
const LOGO_CATALOG={
  bank:[
    ...
    {name:'Zenith',file:'',want:'Zenith.png'},
    {name:'UBA',file:'',want:'UBA.png'},
    {name:'Kuda',file:'',want:'Kuda.png'},
    {name:'Opay',file:'',want:'Opay.png'},
    {name:'Moniepoint',file:'',want:'Moniepoint.png'},
    {name:'PalmPay',file:'',want:'PalmPay.png'},
    {name:'ALAT by Wema',file:'',want:'Wema.png'},
    {name:'Stanbic IBTC',file:'',want:'Stanbic.png'},
    {name:'Fidelity',file:'',want:'Fidelity.png'},
    {name:'FCMB',file:'',want:'FCMB.png'},
    {name:'Sterling',file:'',want:'Sterling.png'},
    {name:'Union Bank',file:'',want:'Union.png'},
    {name:'Ecobank',file:'',want:'Ecobank.png'},
    {name:'Polaris',file:'',want:'Polaris.png'},
    {name:'Providus',file:'',want:'Providus.png'},
    {name:'Renmoney',file:'Renmoney.png'},
    {name:'Carbon',file:'',want:'Carbon.png'},
    {name:'Cash',file:'',icon:'💵'},
    {name:'USD Cash',file:'',icon:'💵',usd:true},
  ],
  platform:[
    {name:'PiggyVest',file:'Piggy.png',currency:'NGN',color:'#c8f542'},
    {name:'Cowrywise',file:'',want:'Cowrywise.png',currency:'NGN',color:'#0066f5'},
    ...
    {name:'Chaka',file:'',want:'Chaka.png',currency:'USD',color:'#7b61ff'},
    {name:'Kuda Save',file:'',want:'Kuda.png',currency:'NGN',color:'#40196d'},
    {name:'Renmoney Savings',file:'Renmoney.png',currency:'NGN',color:'#4a8aee'},
    {name:'ARM',file:'',want:'ARM.png',currency:'NGN',color:'#1d4f91'},
    {name:'Stanbic IBTC Asset Management',file:'',want:'Stanbic.png',currency:'NGN',color:'#0033a1'},
    {name:'Meristem',file:'',want:'Meristem.png',currency:'NGN',color:'#00843d'},
  ],
};
